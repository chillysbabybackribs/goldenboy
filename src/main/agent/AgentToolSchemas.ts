...
export const UNRESTRICTED_DEV_TOOL_SCHEMAS: AgentToolSchemaSummary[] = [
  ...
  schema('browser.hover', 'Move the native pointer over an element by selector.', { type: 'object', required: ['selector'], properties: { selector: { type: 'string' }, tabId: { type: 'string' } } }),
