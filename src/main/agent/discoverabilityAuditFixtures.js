...
exports.DISCOVERABILITY_AUDIT_SCENARIOS = void 0;
exports.discoverabilityScenarioById = discoverabilityScenarioById;
exports.DISCOVERABILITY_AUDIT_SCENARIOS = [
    {
...
function discoverabilityScenarioById(id) {
    const scenario = exports.DISCOVERABILITY_AUDIT_SCENARIOS.find((entry) => entry.id === id);
    if (!scenario)
        throw new Error(`Unknown discoverability audit scenario: ${id}`);
    return scenario;
}
//# sourceMappingURL=discoverabilityAuditFixtures.js.map