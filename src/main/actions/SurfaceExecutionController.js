...
exports.SurfaceExecutionController = void 0;
class SurfaceExecutionController {
    ...
    queue = [];
    active = null;
    constructor(surface, execute, onPolicyFail) {
        this.surface = surface;
        this.execute = execute;
        this.onPolicyFail = onPolicyFail;
    }
    submit(action, policy) {
...
exports.SurfaceExecutionController = SurfaceExecutionController;
//# sourceMappingURL=SurfaceExecutionController.js.map