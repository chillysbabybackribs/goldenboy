...
import { BrowserState, BrowserNavigationState, BrowserDownloadState, BrowserPermissionRequest, BrowserHistoryEntry, BrowserSurfaceStatus, TabInfo, BookmarkEntry, ExtensionInfo } from './browser';
...
export type AppEventPayloads = {
    ...
    [AppEventType.LOG_ADDED]: {
        log: LogRecord;
    };
    [AppEventType.WINDOW_BOUNDS_CHANGED]: {
        role: PhysicalWindowRole;
        bounds: WindowBounds;
        displayId: number;
    };
    [AppEventType.WINDOW_FOCUSED]: {
        role: PhysicalWindowRole;
    };
    [AppEventType.EXECUTION_SPLIT_CHANGED]: {
        ratio: number;
    };
    [AppEventType.EXECUTION_LAYOUT_APPLIED]: {
        preset: ExecutionLayoutPreset;
    };
    [AppEventType.SURFACE_ACTION_SUBMITTED]: {
        record: SurfaceActionRecord;
    };
    [AppEventType.SURFACE_ACTION_STARTED]: {
        record: SurfaceActionRecord;
    };
    [AppEventType.SURFACE_ACTION_COMPLETED]: {
        record: SurfaceActionRecord;
    };
    [AppEventType.SURFACE_ACTION_FAILED]: {
        record: SurfaceActionRecord;
    };
    [AppEventType.SURFACE_ACTION_RESULT_UPDATED]: {
        record: SurfaceActionRecord;
    };
    [AppEventType.APP_STATE_SYNCED]: {
        state: AppState;
    };
    [AppEventType.MODEL_PROVIDER_DETECTED]: {
        providerId: ProviderId;
        available: boolean;
        detail: string;
    };
    [AppEventType.MODEL_PROVIDER_STATUS_CHANGED]: {
        runtime: ProviderRuntime;
    };
    [AppEventType.MODEL_INVOCATION_STARTED]: {
        taskId: string;
        providerId: ProviderId;
    };
    [AppEventType.MODEL_INVOCATION_PROGRESS]: {
        progress: InvocationProgress;
    };
    [AppEventType.MODEL_INVOCATION_COMPLETED]: {
        result: InvocationResult;
    };
    [AppEventType.MODEL_INVOCATION_FAILED]: {
        taskId: string;
        providerId: ProviderId;
        error: string;
    };
    [AppEventType.BROWSER_SURFACE_CREATED]: {
        profileId: string;
        partition: string;
    };
    [AppEventType.BROWSER_NAVIGATION_STARTED]: {
        url: string;
    };
    [AppEventType.BROWSER_NAVIGATION_UPDATED]: {
        navigation: BrowserNavigationState;
    };
    [AppEventType.BROWSER_NAVIGATION_COMPLETED]: {
        url: string;
        title: string;
    };
    [AppEventType.BROWSER_NAVIGATION_FAILED]: {
        url: string;
        errorCode: number;
        errorDescription: string;
    };
    [AppEventType.BROWSER_TITLE_UPDATED]: {
        title: string;
        url: string;
    };
    [AppEventType.BROWSER_HISTORY_UPDATED]: {
        entries: BrowserHistoryEntry[];
    };
    [AppEventType.BROWSER_DOWNLOAD_STARTED]: {
        download: BrowserDownloadState;
    };
    [AppEventType.BROWSER_DOWNLOAD_UPDATED]: {
        download: BrowserDownloadState;
    };
    [AppEventType.BROWSER_DOWNLOAD_COMPLETED]: {
        download: BrowserDownloadState;
    };
    [AppEventType.BROWSER_PERMISSION_REQUESTED]: {
        request: BrowserPermissionRequest;
    };
    [AppEventType.BROWSER_PERMISSION_RESOLVED]: {
        request: BrowserPermissionRequest;
    };
    [AppEventType.BROWSER_STATUS_UPDATED]: {
        status: BrowserSurfaceStatus;
        detail?: string;
    };
    [AppEventType.BROWSER_STATE_CHANGED]: {
        state: BrowserState;
    };
    [AppEventType.BROWSER_TAB_CREATED]: {
        tab: TabInfo;
    };
    [AppEventType.BROWSER_TAB_CLOSED]: {
        tabId: string;
    };
    [AppEventType.BROWSER_TAB_ACTIVATED]: {
        tabId: string;
    };
    [AppEventType.BROWSER_TAB_UPDATED]: {
        tab: TabInfo;
    };
    [AppEventType.BROWSER_BOOKMARK_ADDED]: {
        bookmark: BookmarkEntry;
    };
    [AppEventType.BROWSER_BOOKMARK_REMOVED]: {
        bookmarkId: string;
    };
    [AppEventType.BROWSER_EXTENSION_LOADED]: {
        extension: ExtensionInfo;
    };
    [AppEventType.BROWSER_EXTENSION_REMOVED]: {
        extensionId: string;
    };
    [AppEventType.TERMINAL_SESSION_CREATED]: {
        session: TerminalSessionInfo;
    };
    [AppEventType.TERMINAL_SESSION_STARTED]: {
        session: TerminalSessionInfo;
    };
    [AppEventType.TERMINAL_SESSION_OUTPUT]: {
        sessionId: string;
        data: string;
    };
    [AppEventType.TERMINAL_SESSION_RESIZED]: {
        sessionId: string;
        cols: number;
        rows: number;
    };
    [AppEventType.TERMINAL_SESSION_EXITED]: {
        sessionId: string;
        exitCode: number;
    };
    [AppEventType.TERMINAL_SESSION_ERROR]: {
        sessionId: string;
        error: string;
    };
    [AppEventType.TERMINAL_SESSION_RESTARTED]: {
        oldSessionId: string;
        session: TerminalSessionInfo;
    };
    [AppEventType.TERMINAL_STATUS_UPDATED]: {
        sessionId: string;
        status: TerminalSessionStatus;
    };
    [AppEventType.TERMINAL_SESSION_REATTACHED]: {
        session: TerminalSessionInfo;
