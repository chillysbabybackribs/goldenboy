...
export type BrowserOperationKind =
  ...
  | 'browser.get-dialogs'
  | 'browser.accept-dialog'
  | 'browser.dismiss-dialog'
  | 'browser.get-actionable-elements'
...
export type BrowserOperationLedgerSummaryValue =
  | string
  | number
  | boolean
  | null
...
export type BrowserOperationExecutionContext = Partial<Pick<
  ...
  'taskId' | 'tabId' | 'source' | 'agentId' | 'runId'
>>;
