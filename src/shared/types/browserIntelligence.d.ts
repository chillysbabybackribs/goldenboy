...
export type BrowserActionability = 'clickable' | 'typeable' | 'selectable' | 'navigational' | 'dismissible' | 'unknown';
...
export type BrowserFormFieldKind = 'text' | 'email' | 'password' | 'search' | 'tel' | 'url' | 'number' | 'checkbox' | 'radio' | 'select' | 'textarea' | 'hidden' | 'unknown';
...
export declare function createEmptyBrowserTaskMemory(taskId: string): BrowserTaskMemory;
