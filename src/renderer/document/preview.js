...
exports.buildSandboxedHtmlDocument = buildSandboxedHtmlDocument;
exports.formatArtifactMeta = formatArtifactMeta;
...
function buildSandboxedHtmlDocument(content) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
function formatArtifactMeta(view) {
    return [
